...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const { docs } = await payload.find({
    collection: 'posts',
    where: { slug: { equals: slug }, postType: { equals: 'blog' } },
    depth: 0,
    limit: 1,
  })
          ...
          <div className="grid lg:grid-cols-3 gap-12">
                ...
                {contentHtml ? (
                  <div
                    className="prose prose-lg max-w-none text-gray-700 leading-relaxed
                      ...
                      prose-blockquote:border-l-4 prose-blockquote:border-[#E2B748] prose-blockquote:italic prose-blockquote:text-[#16697A]"
            ...
            <aside className="space-y-6">
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h3 className="font-heading text-xl text-[#16697A] mb-1">Recent Posts</h3>
